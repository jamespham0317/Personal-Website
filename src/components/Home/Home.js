            ...
            <Col lg={10} xl={9} className="home-header">
              <div className="home-hero-shell">
                ...
                <p className="home-hero-copy">
                  I build reliable software across web, cloud, and systems. I focus on projects that are useful, technically solid, and enjoyable to use, from React interfaces and Node backends to C++ graphics work and Python ML pipelines.
                </p>
